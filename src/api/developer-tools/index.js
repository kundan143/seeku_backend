...
module.exports = async (app, jwt) => {
	...
	app.use(ROOT_BASE_URL_DEVELOPER_TOOLS + '/componentLock', jwt, apiActivityLogger, require('../developer-tools/componentLockAPI'));
	app.use(ROOT_BASE_URL_DEVELOPER_TOOLS + '/cronJobs', jwt, apiActivityLogger, require('../developer-tools/cronJobsAPI'));
