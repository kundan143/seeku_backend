...
module.exports = async (app, jwt) => {
    ...
    app.use(ROOT_BASE_URL_hr + '/loanAdvance', jwt, apiActivityLogger, require('../hr/loanAdvanceAPI'));
    ...
    app.use(ROOT_BASE_URL_hr + '/customMailLog', jwt, apiActivityLogger, require('../hr/customMailLogAPI'));
