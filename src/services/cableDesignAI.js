...
- If the user gave additional requirements/notes, follow them wherever they don't conflict with the cable type's standard construction or a forced conductor class rule.`;
...
function buildQuickDesignUserPrompt(input, modules, forcedClass) {
  ...
  if (input.customRequirement) {
    lines.push(`Additional Requirements / Notes from user: ${input.customRequirement}`);
  }
