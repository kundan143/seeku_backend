const { feeAssignment } = require("../models");
...
exports.addData = async function (body) {
  try {
    var result = await feeAssignment.create(body.data);
...
exports.updateData = async function (body) {
  try {
    await feeAssignment.update(body.data, {
      where: {
        id: body.id,
      },
    });
...
exports.getAllData = async function () {
  try {
    var data = await feeAssignment.findAll({
      where: {
        is_active: {
