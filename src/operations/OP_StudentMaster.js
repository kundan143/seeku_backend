const { studentMaster } = require("../models");
...
exports.addData = async function (body) {
  try {
    var result = await studentMaster.create(body.data);
...
exports.updateData = async function (body) {
  try {
    await studentMaster.update(body.data, {
      where: {
        id: body.id,
      },
    });
...
exports.getAllData = async function () {
  try {
    var data = await studentMaster.findAll({
      where: {
        is_active: {
