...
exports.addData = async function (body) {
	try {
		var result = await designationMaster.create(body.data);
...
exports.updateData = async function (body) {
	try {
		await designationMaster.update(body.data, {
			where: {
				id: body.id
			}
		});
...
exports.deleteData = async function (body) {
	try {
		await designationMaster.destroy({
			where: {
				id: body.id
			}
		});
...
exports.getAllData = async function () {
	try {
		var data = await designationMaster.findAll({
			order: [
				['id', 'ASC']
			]
		});
