const { armoringInformation } = require("../models");
...
exports.addData = async function (body) {
    try {
        var result = await armoringInformation.create(body.data);
...
exports.updateData = async function (body) {
    try {
        await armoringInformation.update(body.data, {
            where: {
                id: body.id
            }
        });
...
exports.getAllData = async function () {
    try {
        var data = await armoringInformation.findAll({
            order: [
                ['id', 'ASC']
            ]
        });
