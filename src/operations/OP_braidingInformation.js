const { braidingInformation } = require("../models");
...
exports.addData = async function (body) {
  try {
    var result = await braidingInformation.create(body.data);
...
exports.updateData = async function (body) {
  try {
    await braidingInformation.update(body.data, {
      where: {
        id: body.id,
      },
    });
...
exports.getAllData = async function () {
  try {
    var data = await braidingInformation.findAll({
      order: [["id", "ASC"]],
    });
