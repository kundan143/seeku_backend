const { cableCategoryMaster } = require("../models");
...
exports.addData = async function (body) {
    try {
        var result = await cableCategoryMaster.create(body.data);
...
exports.updateData = async function (body) {
    try {
        await cableCategoryMaster.update(body.data, {
            where: {
                id: body.id
            }
        });
...
exports.deleteData = async function (body) {
    try {
        await cableCategoryMaster.destroy({
            where: {
                id: body.id
            }
        });
