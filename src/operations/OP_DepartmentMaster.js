const { departmentMaster } = require("../models");
...
exports.addData = async function (body) {
	try {
		var result = await departmentMaster.create(body.data);
...
exports.updateData = async function (body) {
	try {
		await departmentMaster.update(body.data, {
			where: {
				id: body.id
			}
		});
...
exports.getAllData = async function () {
	try {
		var data = await departmentMaster.findAll({
			order: [
				['id', 'ASC']
			]
		});
