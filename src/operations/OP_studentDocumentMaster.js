const { studentDocumentMaster } = require("../models");
...
exports.addData = async function (body) {
  try {
    var result = await studentDocumentMaster.create(body.data);
...
exports.updateData = async function (body) {
  try {
    await studentDocumentMaster.update(body.data, {
      where: {
        id: body.id,
      },
    });
...
exports.getAllData = async function () {
  try {
    var data = await studentDocumentMaster.findAll({
      where: {
        is_active: {
