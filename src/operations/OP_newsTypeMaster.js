const { newsTypeMaster } = require("../models");
...
exports.addData = async function (body) {
  try {
    var result = await newsTypeMaster.create(body.data);
...
exports.updateData = async function (body) {
  try {
    await newsTypeMaster.update(body.data, {
      where: {
        id: body.id,
      },
    });
...
exports.getAllData = async function (body) {
  try {
    var data = await newsTypeMaster.findAll({
      where: {
        status: {
