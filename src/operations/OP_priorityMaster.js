const { priorityMaster } = require("../models");
...
exports.addData = async function (body) {
  try {
    var result = await priorityMaster.create(body.data);
...
exports.updateData = async function (body) {
  try {
    await priorityMaster.update(body.data, {
      where: {
        id: body.id,
      },
    });
...
exports.getAllData = async function (body) {
  try {
    var data = await priorityMaster.findAll({
      where: {
        status: {
