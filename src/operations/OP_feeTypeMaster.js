const { feeTypeMaster } = require("../models");
...
exports.addData = async function (body) {
  try {
    var result = await feeTypeMaster.create(body.data);
...
exports.updateData = async function (body) {
  try {
    await feeTypeMaster.update(body.data, {
      where: {
        id: body.id,
      },
    });
...
exports.getAllData = async function () {
  try {
    var data = await feeTypeMaster.findAll({
      where: {
        is_active: {
