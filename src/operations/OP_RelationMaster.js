const { relationMaster } = require("../models");
...
exports.addData = async function (body) {
  try {
    var result = await relationMaster.create(body.data);
...
exports.updateData = async function (body) {
  try {
    await relationMaster.update(body.data, {
      where: {
        id: body.id,
      },
    });
...
exports.getAllData = async function (body) {
  try {
    var data = await relationMaster.findAll({
      where: {
        status: true, // Exclude records with status 0
      },
      order: [["id", "ASC"]],
    });
...
exports.getOneData = async function (id) {
  try {
    var data = await relationMaster.findOne({
      where: {
        id: id,
